...
fuga<-read.csv2("//nas//Datos//RespaldoPC//IVECLE01//1. Fugados 2016//2017//Fugados PAT Junio 2017//Pat-R-final.csv",head=T)

head(fuga)
names(fuga)

#[1] "ID"                     "Nro..Poliza"            "Fecha.vigencia"         "Cod.Mes.Activacion"    
#[5] "Cod.Dif.Prima"          "Cod.Edad"               "Cod.Mes.Inter"          "Tarjeta"               
#[9] "Cuenta.Polizas"         "Cuenta.Vigentes"        "Cuenta.Anuladas"        "Cuenta.Ayudas"         
#[13] "Cuenta.No.Pagos"        "Rango.Remuneracion"     "Sexo.Asociado"          "Agencia"               
#[17] "Tipo.Contrato.Agente"   "Estado.Contrato.Agente" "Motivo.de.Anulacion"    "CLV"                   
#[21] "Churn"
...
write.table(prob, "//nas//Datos//RespaldoPC//IVECLE01//1. Fugados 2016//2017//Fugados PAT Junio 2017//Indicador-Global-histórico.txt")
write.table(prob2, "//nas//Datos//RespaldoPC//IVECLE01//1. Fugados 2016//2017//Fugados PAT Junio 2017//Probabilidad-Global-histórico.txt")
...
#Guardar probabilidades en un excel
write.table(prob, "//nas//Datos//RespaldoPC//IVECLE01//1. Fugados 2016//2017//Fugados PAT Junio 2017//Indicador-Global-DatosNuevos-mayo.txt")
write.table(prob2, "//nas//Datos//RespaldoPC//IVECLE01//1. Fugados 2016//2017//Fugados PAT Junio 2017//Probabilidad-Global-DatosNuevos-mayo.txt")
