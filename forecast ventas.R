...
library(tseries)
myebacklog <-read.csv2("//nas//Datos//Liquidacion//Liquidacion 1//PAMELA//Nuevo Informe Recaudación//08.2017 (Período análisis Mayo 2017)//Carlos Ahumada.csv",head=T)
...
#[7] "Seguros.Familiares"    "Seguros.Oncológicos"   "Accidentes.Personales"
